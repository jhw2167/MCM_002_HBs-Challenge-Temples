...
public class ModBlocks {
    ...
    public static void initialize(BalmBlocks blocks) {
        ...
        blocks.register(() -> challengeDoor = new ChallengeDoor(),
            () -> itemBlock(challengeDoor),
            id("challenge_door"));
            
        blocks.register(() -> challengeGoldPlate = new ChallengePressurePlates.ChallengeLightPlate(),
            () -> itemBlock(challengeGoldPlate),
            id("challenge_gold_plate"));
            
        blocks.register(() -> challengeClearingPlate = new ChallengePressurePlates.ChallengeClearingPlate(),
            () -> itemBlock(challengeClearingPlate),
            id("challenge_clearing_plate"));
        ...
        blocks.register(() -> challengeStairs = new ChallengeStairs(),
            () -> itemBlock(challengeStairs),
            id("challenge_stairs"));
            
        blocks.register(() -> challengePushableStairs = new ChallengePushableStairs(),
            () -> itemBlock(challengePushableStairs),
            id("challenge_pushable_stairs"));
            
        blocks.register(() -> challengeFence = new ChallengeFence(),
            () -> itemBlock(challengeFence),
            id("challenge_fence"));
            
        blocks.register(() -> challengeFenceGate = new ChallengeFenceGate(),
            () -> itemBlock(challengeFenceGate),
            id("challenge_fence_gate"));
